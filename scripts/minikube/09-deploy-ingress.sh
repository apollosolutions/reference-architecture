...
echo "=== Step 09: Deploying Ingress ==="
...
if grep -q "^export ROUTER_URL=" "$ENV_FILE"; then
    ...
    echo "" >> "$ENV_FILE"
    echo "# Router URL (generated by 09-deploy-ingress.sh)" >> "$ENV_FILE"
...
echo ""
echo "Next step: Run 10-deploy-client.sh to deploy the client application (optional)"
