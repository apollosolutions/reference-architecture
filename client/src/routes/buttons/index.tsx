import { Box, Button, ButtonProps, Container, Grid, GridItem, Text } from '@chakra-ui/react'
    ...
    <>
      <Container bg="beige.400" maxW={"3xl"}>
        <Box padding='10' maxW='xl'>
          <Text>Buttons appear to use the 600 weight of colors defined in a color scheme</Text>
